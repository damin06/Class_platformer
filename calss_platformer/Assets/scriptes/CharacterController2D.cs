...
public class CharacterController2D  : MonoBehaviour
{
    ...
    {
        Vector2 raycastOrigin = _rigidbody.position - new Vector2(0,_capsuleColider.size.y * 0.5f);

        _raycastPosition[0] = raycastOrigin +(Vector2.left * _capsuleColider.size.x * 0.25f +Vector2.up * 0.1f);
        _raycastPosition[1] = raycastOrigin;
        _raycastPosition[2] = raycastOrigin +(Vector2.right * _capsuleColider.size.x * 0.25f +Vector2.up * 0.1f);
